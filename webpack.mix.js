...
mix.sass('src/assets/scss/chrome.scss', 'dist/falcon-chrome.css')
    .sass('src/assets/scss/firefox.scss', 'dist/falcon-firefox.css')
...
mix.copy('src/background.js', 'dist/chrome/background.js')
    ...
    .copy('dist/falcon-chrome.css', 'dist/chrome/assets/falcon.css')
...
// now copy the chrome folder to firefox
mix.copyDirectory('dist/chrome', 'dist/firefox');
mix.copy('dist/falcon-firefox.css', 'dist/firefox/assets/falcon.css');
...
mix.webpackConfig({
    plugins: [
        ...
        //     ],
        //     "output": {
        //         "fileName": 'dist/firefox/manifest.json'
        //     }
        // })
    ]
})
